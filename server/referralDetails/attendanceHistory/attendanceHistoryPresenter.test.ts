  ...
  describe('attendanceHistoryTableArgs', () => {
    it('should return correct table rows for sessions', () => {
      ...
      expect(rows[0]).toEqual([
        ...
        {
          html: `<a href="/1234567890/session-1/pre-group-one-to-one-attendance-and-session-notes?referralId=${referralId}&isAttendanceHistory=true" class="govuk-link">Pre-group one-to-one attendance and notes</a>`,
        },
      ])
        ...
        attendanceHistory: [
          {
            ...
            date: '11 July 2025',
            time: 'Midday to 1pm',
            timeWithCapitalisedMidday: 'Midday to 1pm',
        ...
        attendanceHistory: [
          {
            ...
            date: '11 July 2025',
            time: '10:30am',
            timeWithCapitalisedMidday: '10:30am',
