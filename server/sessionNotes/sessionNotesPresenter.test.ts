...
describe('SessionNotesPresenter', () => {
  ...
  it('builds URL from sessionName', () => {
    ...
    expect(presenter.pageUrl).toBe(
      '/b2c3d4e5-f6a7-8901-bcde-f23456789012/c3d4e5f6-a7b8-9012-cdef-345678901234/building-motivation-attendance-and-session-notes',
    )
  })
  ...
  it('builds URL from BFF sessionName when provided', () => {
    ...
    expect(presenter.pageUrl).toBe(
      '/b2c3d4e5-f6a7-8901-bcde-f23456789012/c3d4e5f6-a7b8-9012-cdef-345678901234/introduction-to-building-choices-attendance-and-session-notes',
    )
  })
  ...
  it('builds catch-up URL from session name and appends session-notes', () => {
    ...
    expect(presenter.pageUrl).toBe(
      '/b2c3d4e5-f6a7-8901-bcde-f23456789012/c3d4e5f6-a7b8-9012-cdef-345678901234/building-motivation-catch-up-attendance-and-session-notes',
    )
  })
  ...
  it('builds one-to-one URL from session name and appends session-notes', () => {
    ...
    expect(presenter.pageUrl).toBe(
      '/b2c3d4e5-f6a7-8901-bcde-f23456789012/c3d4e5f6-a7b8-9012-cdef-345678901234/getting-started-one-to-one-attendance-and-session-notes',
    )
  })
  ...
  it('builds post-programme review URL from session name and appends session-notes', () => {
    ...
    expect(presenter.pageUrl).toBe(
      '/b2c3d4e5-f6a7-8901-bcde-f23456789012/c3d4e5f6-a7b8-9012-cdef-345678901234/post-programme-review-for-jane-doe-attendance-and-session-notes',
    )
  })
