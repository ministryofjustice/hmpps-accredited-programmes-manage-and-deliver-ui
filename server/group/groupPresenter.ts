  ...
  getSubNavArgs(): { items: { text: string; href: string; active: boolean }[] } {
    ...
    return {
      items: [
        ...
        {
          text: `Completed (${this.section === GroupListPageSection.COMPLETED ? this.groupListItems.totalElements : this.otherGroupListCountTotal})`,
          href: possiblyAppendParams(`/groups/completed`, this.params),
          active: this.section === GroupListPageSection.COMPLETED,
        },
      ],
    }
  }
