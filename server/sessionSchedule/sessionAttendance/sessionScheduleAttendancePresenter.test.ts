...
describe('SessionScheduleAttendancePresenter', () => {
        ...
        sessions: [
          {
            ...
            timeWithCapitalisedMidday: '9:30am to 11:00am',
          ...
          },
          {
            ...
            timeWithCapitalisedMidday: '2:00pm to 3:30pm',
  ...
  describe('navigationPresenter', () => {
    it('creates a navigation presenter with sessions active', () => {
      ...
      expect(presenter.getMojSubNavigationArgs()).toBeDefined()
    })
  })
            ...
            sessions: [
              {
                ...
                timeWithCapitalisedMidday: '1pm to 3:30pm',
            ...
            sessions: [
              {
                ...
                timeWithCapitalisedMidday: '10:00am to 11:30am',
            ...
            sessions: [
              {
                ...
                isCatchup: false,
                participants: undefined as unknown as { name: string }[],
                dateOfSession: undefined as unknown as string,
                timeOfSession: undefined as unknown as string,
                timeWithCapitalisedMidday: undefined as unknown as string,
            ...
            sessions: [
              {
                ...
                timeWithCapitalisedMidday: '9:00am to 10:00am',
