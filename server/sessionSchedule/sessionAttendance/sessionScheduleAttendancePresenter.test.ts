...
describe('SessionScheduleAttendancePresenter', () => {
  ...
  describe('accordion content', () => {
    ...
    it('does not render table when module has no sessions but still shows schedule button', () => {
      ...
      expect(secondModuleContent).toContain(`href="/${groupId}/module/module-2/schedule-session-type"`)
    ...
    it('renders schedule button with correct href', () => {
      ...
      expect(firstModuleContent).toContain(`href="/${groupId}/module/module-1/schedule-session-type"`)
    ...
    it('handles button text ending with "review" instead of "session"', () => {
      ...
      expect(content).toContain(`href="/${groupId}/module/module-1/schedule-session-type"`)
    })
